...
public class FileReader {
    public static void loadMembers(){
        try {
            Scanner sc = new Scanner(new File("Delfinen/src/FileHandling/Members.txt"));
    ...
    public static void loadResults() {
        try {
            Scanner sc = new Scanner(new File("Delfinen/src/FileHandling/Results.txt"));
            while(sc.hasNextLine()){
